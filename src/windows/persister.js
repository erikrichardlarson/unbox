...
class Persister {
    ...
    writeToLocal(mostRecentArtist, mostrecentTrack, mostRecentLabel, mostrecentRemix, playlistHistory) {
        ...
        fs.writeFileSync(this.streamJSONPath, JSON.stringify({ artist: mostRecentArtist, track: mostrecentTrack, label: mostRecentLabel, remix: mostrecentRemix }));
        ...
        fs.writeFileSync(this.historyJSONPath, JSON.stringify({ tracks: playlistHistory }));

    }

    writeToRemote(mostRecentArtist, mostrecentTrack, mostRecentLabel, mostrecentRemix) {
