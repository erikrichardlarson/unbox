...
class Playlist {
  ...
  update() {
    ...
    if (this.mode == 'rekordbox') {
      this.poller.rekordbox();
    }

    if (this.mode == 'rekordbox-realtime') {
      this.poller.rekordboxRealtime();
    }
    ...
    this.persister.writeToLocal(mostRecentArtist, mostrecentTrack, mostRecentLabel, mostrecentRemix);
    this.persister.writeToRemote(mostRecentArtist, mostrecentTrack, mostRecentLabel, mostrecentRemix);
  }
