...
2. **Open the unbox zip file you downloaded above, and open the unbox app. Select your mode. If you select real-time rekordbox on Windows another launcher will come up, just select the version of rekordbox you're on and click launch, please leave all other settings intact. ** On Windows you'll want to click the unbox.exe file. If Windows or Mac asks you to trust unbox, you'll need to do that. The source code is in this repo if you're concerned about security. When the app is open you'll see this window:  
<p align="center">
